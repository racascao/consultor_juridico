...
## Packaging operacional

```text
OFFICIAL_COMMAND: consultor_juridico
INTERACTIVE_UI: RICH
ACTIVE_MODEL_IN_HEADER: gemma4:12b
LEGAL_RULE_LOADING: RICH_STATUS_TTY_ONLY
OLLAMA_TRUE_STREAMING: DEFERRED_STREAM_FALSE_FROZEN
BOOTSTRAP: IDEMPOTENT
MODEL_AUTO_PULL: ENABLED
COMPOSE_APP_ROLE: ONE_SHOT_BOOTSTRAP
```

Essa camada foi concluída após o freeze do motor. Ela pode acessar a internet
somente para preparar corpus/modelo ausentes; o pipeline de consulta permanece
integralmente local e metodologicamente inalterado.
